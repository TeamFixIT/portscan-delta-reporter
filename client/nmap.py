...
* David Peltier
* Ed Jones
* Jared Stanbrook - forked to make changes for portScanner app
...
__version__ = "0.7.2"
__last_modification__ = "2025.10.17"
...
class PortScannerAsync:
    ...
    def scan(
        ...
        """
        Scan given hosts in a separate process and return host by host
        result using callback function

        PortScannerError exception from standard nmap is catched and you
        won't know about but get None as scan_data
        ...
        :param sudo: launch nmap with sudo if true
        :param timeout: int, if > zero, will terminate scan after seconds,
                       otherwise will wait indefintely
        ...
        for redirecting_output in ["-oX", "-oA"]:
            ...
            assert redirecting_output not in arguments, error_msg
