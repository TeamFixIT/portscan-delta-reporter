...
!(function (t, e) {
  ...
  class Ni extends W {
    constructor(t, e) {
      super(t, e),
        ...
        (this._backdrop = this._initialiseBackDrop()),
        (this._focustrap = this._initialiseFocusTrap()),
        (this._isShown = !1),
        (this._isTransitioning = !1),
  ...
  class ln extends W {
    ...
    _initialiseOnDelegatedTarget(t) {
      ...
      for (const e of t)
        if ("click" === e)
          P.on(this._element, this.constructor.eventName("click"), this._config.selector, (t) => {
            this._initialiseOnDelegatedTarget(t).toggle();
          });
        else if ("manual" !== e) {
          const t =
              e === nn
          ...
          P.on(this._element, t, this._config.selector, (t) => {
            const e = this._initialiseOnDelegatedTarget(t);
  ...
  class _n extends W {
    ...
    refresh() {
      this._initialiseTargetsAndObservables(),
    ...
    _initialiseTargetsAndObservables() {
