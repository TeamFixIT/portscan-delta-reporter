...
class Animator {
  ...
  _notify(t, e, i, s) {
    const a = e.listeners[s],
      n = e.duration;
    a.forEach((s) =>
      s({ chart: t, initial: e.initial, numSteps: n, currentStep: Math.min(i - e.start, n) })
    );
  }
  _refresh() {
    this._request ||
  ...
  _update(t = Date.now()) {
    ...
    this._charts.forEach((i, s) => {
      ...
      for (; o >= 0; --o)
        (n = a[o]),
          n._active
            ? (n._total > i.duration && (i.duration = n._total), n.tick(t), (r = !0))
...
function toClip(t) {
  let e, i, s, a;
  return (
    isObject(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (a = t.left)) : (e = i = s = a = t),
...
class DatasetController {
  ...
  parsePrimitiveData(t, e, i, s) {
    ...
    let d, u, g;
    for (d = 0, u = s; d < u; ++d)
      (g = d + i), (c[d] = { [o]: h || a.parse(l[g], g), [r]: n.parse(e[g], g) });
    return c;
  }
  parseArrayData(t, e, i, s) {
    ...
    let r, l, h, c;
    for (r = 0, l = s; r < l; ++r)
      (h = r + i), (c = e[h]), (o[r] = { x: a.parse(c[0], h), y: n.parse(c[1], h) });
    return o;
  }
  parseObjectData(t, e, i, s) {
    ...
    for (h = 0, c = s; h < c; ++h)
      (d = h + i),
        (u = e[d]),
        (l[h] = { x: a.parse(resolveObjectKey(u, o), d), y: n.parse(resolveObjectKey(u, r), d) });
    return l;
  }
  getParsed(t) {
  ...
  applyStack(t, e, i) {
    const s = this.chart,
      ...
      n = e[t.axis];
    return applyStack(
      { keys: getSortedDatasetIndices(s, !0), values: e._stacks[t.axis]._visualValues },
      n,
      a.index,
      { mode: i }
    );
  ...
  getContext(t, e, i) {
    ...
    if (t >= 0 && t < this._cachedMeta.data.length) {
      ...
      (a = e.$context || (e.$context = createDataContext(this.getContext(), t, e))),
...
function parseArrayOrPrimitive(t, e, i, s) {
  ...
  let h, c, d, u;
  for (h = i, c = i + s; h < c; ++h)
    (u = e[h]), (d = {}), (d[a.axis] = r || a.parse(o[h], h)), l.push(parseValue(u, d, n, h));
  return l;
}
...
class BarController extends DatasetController {
  ...
  initialise() {
    (this.enableOptionSharing = !0), super.initialise();
  ...
  _getStacks(t, e) {
    ...
    for (const i of s)
      if (
        (void 0 === e || !o(i)) &&
        ((!1 === a || -1 === n.indexOf(i.stack) || (void 0 === a && void 0 === i.stack)) &&
          n.push(i.stack),
        i.index === t)
      )
        break;
  ...
  _calculateBarIndexPixels(t, e) {
    ...
    if (e.grouped) {
      ...
      (o = i.getPixelForValue(this.getParsed(t)[i.axis], t)), (r = Math.min(n, e.min * e.ratio));
...
class DoughnutController extends DatasetController {
  ...
  update(t) {
    const e = this.chart,
      ...
      { ratioX: d, ratioY: u, offsetX: g, offsetY: p } = getRatioAndOffset(c, h, r),
      f = (i.width - n) / d,
      m = (i.height - n) / u,
  ...
  updateElements(t, e, i, s) {
    ...
    for (f = e; f < e + i; ++f) {
      ...
      p && (n.options = g || this.resolveDataElementOptions(f, i.active ? "active" : s)),
        (m += e),
...
class LineController extends DatasetController {
  ...
  initialise() {
    (this.enableOptionSharing = !0), (this.supportsDecimation = !0), super.initialise();
  }
  update(t) {
    const e = this._cachedMeta,
  ...
  updateElements(t, e, i, s) {
    ...
    for (let i = 0; i < b; ++i) {
      ...
      const y = this.getParsed(i),
        ...
        S = (b[u] =
          a || v ? o.getBasePixel() : o.getPixelForValue(r ? this.applyStack(o, y, r) : y[u], i));
      (b.skip = isNaN(k) || isNaN(S) || v),
        (b.stop = i > 0 && Math.abs(y[d] - _[d]) > f),
        p && ((b.parsed = y), (b.raw = l.data[i])),
        c && (b.options = h || this.resolveDataElementOptions(i, g.active ? "active" : s)),
...
class PolarAreaController extends DatasetController {
  ...
  _updateRadius() {
    const t = this.chart,
      ...
      a = Math.max(s / 2, 0),
      n =
        (a - Math.max(i.cutoutPercentage ? (a / 100) * i.cutoutPercentage : 1, 0)) /
  ...
  updateElements(t, e, i, s) {
    ...
    for (let h = e; h < e + i; ++h) {
      const e = t[h],
        ...
        v = (p[g] =
          a || _ ? o.getBasePixel() : o.getPixelForValue(r ? this.applyStack(o, i, r) : i[g], h));
      (p.skip = isNaN(y) || isNaN(v) || _),
        (p.stop = h > 0 && Math.abs(i[u] - b[u]) > m),
        f && ((p.parsed = i), (p.raw = l.data[h])),
        d && (p.options = c || this.resolveDataElementOptions(h, e.active ? "active" : s)),
...
function getNearestRadialItems(t, e, i, s) {
  ...
  return (
    evaluateInteractionItems(t, i, e, function (t, i, n) {
      const { startAngle: o, endAngle: r } = t.getProps(["startAngle", "endAngle"], s),
...
function getAxisItems(t, e, i, s, a) {
  ...
  return (
    evaluateInteractionItems(t, i, e, (t, s, l) => {
      t[o](e[i], a) &&
        (n.push({ element: t, datasetIndex: s, index: l }), (r = r || t.inRange(e.x, e.y, a)));
    }),
    s && !r ? [] : n
  );
}
var Interaction = {
  ...
  modes: {
    ...
    point: (t, e, i, s) =>
      getIntersectItems(t, getRelativePosition(e, t), i.axis || "xy", s, i.includeInvisible || !1),
    nearest(t, e, i, s) {
      const a = getRelativePosition(e, t),
        n = i.axis || "xy",
        o = i.includeInvisible || !1;
...
var layouts = {
  ...
  update(t, e, i, s) {
    ...
    const g = Object.assign({ maxPadding: u, w: n, h: o, x: a.left, y: a.top }, a),
...
function autoSkip(t, e) {
  ...
  if (o > 0) {
    ...
    for (skip(e, h, c, isNullOrUndef(s) ? 0 : r - s, r), t = 0, i = o - 1; t < i; t++)
...
function skip(t, e, i, s, a) {
  ...
  let r,
    ...
    h,
    c = 0;
  for (i = Math.ceil(i), a && ((r = a - s), (i = r / Math.floor(r / i))), h = n; h < 0; )
...
class Scale extends Element {
  ...
  calculateLabelRotation() {
    ...
    let n,
      ...
      r,
      l = s;
    if (!this._isVisible() || !e.display || s >= a || i <= 1 || !this.isHorizontal())
      ...
      c + 6 > n &&
        ...
        (l = toDegrees(
          Math.min(
            ...
            Math.asin(_limitValue(o / r, -1, 1)) - Math.asin(_limitValue(d / r, -1, 1))
          )
        )),
  ...
  _calculatePadding(t, e, i, s) {
    ...
    if (this.isHorizontal()) {
      ...
      r
        ...
        (this.paddingLeft = Math.max(((c - o + n) * this.width) / (this.width - o), 0)),
        (this.paddingRight = Math.max(((d - h + n) * this.width) / (this.width - h), 0));
    } else {
      let i = e.height / 2,
        s = t.height / 2;
  ...
  _computeGridLineItems(t) {
    ...
    if ("top" === n)
      (m = f(this.bottom)), (v = this.bottom - c), (S = m - p), (M = f(t.top) + p), (w = t.bottom);
    else if ("bottom" === n)
      (m = f(this.top)), (M = t.top), (w = f(t.bottom) - p), (v = m + p), (S = this.top + c);
    else if ("left" === n)
      (m = f(this.right)), (y = this.right - c), (k = m - p), (D = f(t.left) + p), (P = t.right);
    else if ("right" === n)
      (m = f(this.left)), (D = t.left), (P = f(t.right) - p), (y = m + p), (k = this.left + c);
    else if ("x" === e) {
  ...
  drawTitle() {
    ...
    "bottom" === e || "center" === e || isObject(e)
      ? ((r += n.bottom), isArray(i.text) && (r += a.lineHeight * (i.text.length - 1)))
      : (r += n.top);
...
class TypedRegistry {
  ...
  unregister(t) {
    const e = this.items,
      ...
      s = this.scope;
    i in e && delete e[i],
      s && i in defaults[s] && (delete defaults[s][i], this.override && delete overrides[i]);
  }
}
...
function createDescriptors(t, { plugins: e, localIds: i }, s, a) {
  ...
  for (const r of e) {
    const e = r.id,
      l = getOpts(s[e], a);
    null !== l &&
      n.push({ plugin: r, options: pluginOpts(t.config, { plugin: r, local: i[e] }, l, o) });
  }
  return n;
}
...
function determineAxis(t, ...e) {
  ...
  for (const i of e) {
    const e =
      i.axis || axisFromPosition(i.position) || (t.length > 1 && idMatchesAxis(t[0].toLowerCase()));
    if (e) return e;
  }
  throw new Error(
...
const hasFunction = (t) =>
  isObject(t) && Object.getOwnPropertyNames(t).reduce((e, i) => e || isFunction(t[i]), !1);
...
class Chart {
  ...
  buildOrUpdateScales() {
    ...
    e &&
      ...
      each(a, (e) => {
        ...
        (void 0 !== a.position &&
          positionIsHorizontal(a.position, o) === positionIsHorizontal(e.dposition)) ||
          (a.position = e.dposition),
          (s[n] = !0);
        let l = null;
        if (n in i && i[n].type === r) l = i[n];
        else {
          (l = new (registry.getScale(r))({ id: n, type: r, ctx: this.ctx, chart: this })),
            (i[l.id] = l);
        }
        l.init(a, t);
      }),
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
      ...
      if (
        (a.type && a.type !== n && (this._destroyDatasetMeta(i), (a = this.getDatasetMeta(i))),
        (a.type = n),
  ...
  _handleEvent(t, e, i) {
    ...
    return (
      (h || e) && ((this._active = o), this._updateHoverStyles(o, s, e)), (this._lastEvent = l), h
    );
  }
...
function pathSegment(t, e, i, s) {
  ...
  for (d = 0; d <= h; ++d)
    (u = a[(r + (f ? h - d : d)) % o]),
      u.skip || (p ? (t.moveTo(u.x, u.y), (p = !1)) : c(t, g, u, f, n.stepped), (g = u));
...
class LineElement extends Element {
  ...
  draw(t, e, i, s) {
    ...
    (this.points || []).length && a.borderWidth && (t.save(), draw(t, this, i, s), t.restore()),
...
function getBarBounds(t, e) {
  ...
  return (
    t.horizontal
      ? ((d = o / 2), (r = Math.min(i, a)), (l = Math.max(i, a)), (h = s - d), (c = s + d))
      : ((d = n / 2), (r = i - d), (l = i + d), (h = Math.min(s, a)), (c = Math.max(s, a))),
...
function minMaxDecimation(t, e, i, s) {
  ...
  for (a = e; a < e + i; ++a) {
    ...
    const e = 0 | o;
    if (e === l)
      r < u ? ((u = r), (h = a)) : r > g && ((g = r), (c = a)), (p = (f * p + n.x) / ++f);
    else {
      const i = a - 1;
...
function _createBoundaryLine(t, e) {
  ...
  return (
    ...
    i.length
      ? new LineElement({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
...
function _drawfill(t, e, i) {
  ...
  s &&
    a.points.length &&
    (clipArea(t, i),
    doFill(t, { line: a, target: s, above: c, below: d, area: i, scale: n, axis: o }),
    unclipArea(t));
}
function doFill(t, e) {
  ...
  afterDatasetsUpdate(t, e, i) {
    ...
    for (o = 0; o < s; ++o)
      (n = t.getDatasetMeta(o)),
        ...
        a.push(l);
    for (o = 0; o < s; ++o)
      (l = a[o]), l && !1 !== l.fill && (l.fill = _resolveTarget(a, o, i.propagate));
  },
  beforeDraw(t, e, i) {
...
class Legend extends Element {
  ...
  _fitCols(t, e, i, s) {
    ...
    return (
      this.legendItems.forEach((t, n) => {
        ...
        n > 0 &&
          u + m + 2 * o > h &&
          ((c += d + o), l.push({ width: d, height: u }), (g += d + o), p++, (d = u = 0)),
  ...
  adjustHitBoxes() {
    ...
    if (this.isHorizontal()) {
      ...
      for (const r of e)
        a !== r.row &&
          ((a = r.row), (o = _alignStartEnd(i, this.left + s, this.right - this.lineWidths[a]))),
          (r.top += this.top + t + s),
  ...
  _draw() {
    ...
    (u = m
      ? { x: _alignStartEnd(a, this.left + h, this.right - i[0]), y: this.top + h + x, line: 0 }
      : {
          x: this.left + h,
      ...
      r.setWidth(this.width),
        m
          ? y > 0 &&
            ...
            ((M = u.y += b),
            u.line++,
            (D = u.x = _alignStartEnd(a, this.left + h, this.right - i[u.line])))
          : y > 0 &&
            M + b > this.bottom &&
            ((D = u.x = D + e[u.line].width + h),
            u.line++,
            (M = u.y = _alignStartEnd(a, this.top + x + h, this.bottom - e[u.line].height)));
      if (
        ((function (t, e, i) {
  ...
  _getLegendItemAt(t, e) {
    ...
    if (_isBetween(t, this.left, this.right) && _isBetween(e, this.top, this.bottom))
      for (a = this.legendHitBoxes, i = 0; i < a.length; ++i)
        if (
          ((s = a[i]),
          _isBetween(t, s.left, s.left + s.width) && _isBetween(e, s.top, s.top + s.height))
        )
...
function calculateItemWidth(t, e, i, s) {
  let a = t.text;
  return (
    a && "string" != typeof a && (a = a.reduce((t, e) => (t.length > e.length ? t : e))),
...
function getTooltipSize(t, e) {
  ...
  if (
    ...
    d && (f += d * h.lineHeight + (d - 1) * e.titleSpacing + e.titleMarginBottom),
    x)
  ) {
    f +=
...
function getBackgroundPoint(t, e, i, s) {
  const { caretSize: a, caretPadding: n, cornerRadius: o } = t,
    { xAlign: r, yAlign: l } = i,
    h = a + n,
    { topLeft: c, topRight: d, bottomLeft: u, bottomRight: g } = toTRBLCorners(o);
  let p = alignX(e, r);
  ...
  return (
    ...
    { x: _limitValue(p, 0, s.width - e.width), y: _limitValue(f, 0, s.height - e.height) }
  );
}
...
class Tooltip extends Element {
    ...
    return (
      each(t, (t) => {
        ...
        pushOrConcat(
          ...
          pushOrConcat(e.lines, invokeCallbackWithFallback(a, "label", this, t)),
          pushOrConcat(
            e.after,
  ...
  getCaretPosition(t, e, i) {
    const { xAlign: s, yAlign: a } = this,
      ...
      { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = toTRBLCorners(o),
      { x: d, y: u } = t,
      { width: g, height: p } = e;
    let f, m, x, b, _, y;
    return (
    ...
    if (a.usePointStyle) {
      ...
      Object.values(o).some((t) => 0 !== t)
        ? (t.beginPath(),
          ...
          (t.fillStyle = n.backgroundColor),
          t.beginPath(),
          addRoundedRectPath(t, { x: i, y: g + 1, w: l - 2, h: r - 2, radius: o }),
          t.fill())
        : ((t.fillStyle = a.multiKeyBackground),
          t.fillRect(e, g, l, r),
    ...
    for (
      ...
      for (
        m = s[_],
          ...
          each(m.before, p),
          b = m.lines,
          o && b.length && (this._drawColorBox(e, t, _, g, i), (d = Math.max(c.lineHeight, r))),
          y = 0,
          k = b.length;
        y < k;
        ++y
  ...
  drawBackground(t, e, i, s) {
    const { xAlign: a, yAlign: n } = this,
      { x: o, y: r } = t,
      { width: l, height: h } = i,
      { topLeft: c, topRight: d, bottomLeft: u, bottomRight: g } = toTRBLCorners(s.cornerRadius);
...
var plugin_tooltip = {
    ...
    beforeUpdate(t, e, i) {
      t.tooltip && t.tooltip.initialise(i);
    },
    reset(t, e, i) {
      t.tooltip && t.tooltip.initialise(i);
    },
...
function generateTicks$1(t, e) {
  ...
  (S = Math.ceil(f / D) - Math.floor(p / D)),
    ...
    "ticks" === s ? ((v = Math.floor(p / D) * D), (k = Math.ceil(f / D) * D)) : ((v = p), (k = f)),
    m && x && a && almostWhole((o - n) / a, D / 1e3)
      ? ((S = Math.round(Math.min((o - n) / D, h))), (D = (o - n) / S), (v = n), (k = o))
      : b
      ? ((v = m ? n : v), (k = x ? o : k), (S = l - 1), (D = (k - v) / S))
      : ((S = (k - v) / D),
        (S = almostEquals(S, Math.round(S), D / 1e3) ? Math.round(S) : Math.ceil(S)));
  ...
  for (
    ...
    (d && v !== n
      ? (i.push({ value: n }),
        v < n && P++,
        almostEquals(Math.round((v + P * D) * y) / y, n, relativeLabelSize(n, _, t)) && P++)
      : v < n && P++);
    P < S;
    ++P
  ) {
  ...
  return (
    x && d && k !== o
      ? i.length && almostEquals(i[i.length - 1].value, o, relativeLabelSize(o, _, t))
...
class LogarithmicScale extends Scale {
  ...
  handleTickRangeOptions() {
    ...
    const a = (e) => (i = t ? i : e),
      n = (t) => (s = e ? s : t);
    i === s && (i <= 0 ? (a(1), n(10)) : (a(changeExponent(i, -1)), n(changeExponent(s, 1)))),
...
function updateLimits(t, e, i, s, a) {
  ...
  s.start < e.l
    ...
    a.start < e.t
      ...
      : a.end > e.b && ((l = (a.end - e.b) / o), (t.b = Math.max(t.b, e.b + l)));
}
...
function drawPointLabelBox(t, e, i) {
  ...
  if (!isNullOrUndef(r)) {
    ...
    Object.values(i).some((t) => 0 !== t)
      ? (t.beginPath(), addRoundedRectPath(t, { x: h, y: c, w: d, h: u, radius: i }), t.fill())
      : t.fillRect(h, c, d, u);
  }
}
...
function parse(t, e) {
  ...
  return (
    ...
    isNumberFinite(o) || (o = "string" == typeof s ? i.parse(o, s) : i.parse(o)),
    null === o
      ? null
      : (a &&
          (o =
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (i.autoSkip
          ? determineUnitForAutoTicks(e.minUnit, this.min, this.max, this._getLabelCapacity(a))
          : determineUnitForFormatting(this, o.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
...
function interpolate(t, e, i) {
  let s,
    ...
    l = t.length - 1;
  i
    ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = _lookupByKey(t, "pos", e)),
      ({ pos: s, time: n } = t[r]),
      ({ pos: a, time: o } = t[l]))
    : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = _lookupByKey(t, "time", e)),
      ({ time: s, pos: n } = t[r]),
      ({ time: a, pos: o } = t[l]));
  const h = a - s;
